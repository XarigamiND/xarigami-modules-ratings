        ...
        foreach ($hookedmodules as $modname => $value) {
            ...
            if (!isset($value[0])) {
                ...
                foreach ($value as $itemtype => $val) {
                    ...
                    if (empty($shownum)) {
                        $shownum = $defaultshownum;
                        xarModSetVar('ratings',"shownum.$modname.$itemtype", isset($defaultshownum)?$defaultshownum:0);
                    }
                ...
                if (empty($shownum)) {
                    $shownum = $defaultshownum;
                    xarModSetVar('ratings',"shownum.$modname", isset($defaultshownum)?$defaultshownum:0);
                }
